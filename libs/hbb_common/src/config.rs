...
pub const RENDEZVOUS_SERVERS: &[&str] = &["123.249.117.0"];
pub const PUBLIC_RS_PUB_KEY: &str = "KUGiYuMMD3JrSXfS5POaKWu01KSD6T9ItUAUYZnG/6ZLD7N+n0dcg4JiJ8lxKztvzArxw3MlejdGBosu6Vlx6Q==";
